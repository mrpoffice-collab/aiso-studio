  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-3 py-2 bg-slate-600 text-white text-sm font-medium rounded-lg hover:bg-slate-700 transition-colors flex items-center gap-1.5"
              >
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-xl">
                    ...
                    {isRewriting ? (
                      <div className="flex flex-col items-center gap-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span>AI is Rewriting Content...</span>
                        </div>
                        <span className="text-sm opacity-75">(Up to 3 iterations - may take 30-60 seconds)</span>
                      </div>
                    ) : (
                      <>
                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex gap-3 mt-4">
                  {auditResult.pdfUrl && (
                    <a
                      href={auditResult.pdfUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 px-4 py-3 bg-slate-700 text-white font-bold rounded-xl hover:bg-slate-800 transition-all flex items-center justify-center gap-2"
                    >
                  ...
                  {auditResult.content && (
                    <button
                      onClick={() => setShowRepurposeModal(true)}
                      className="flex-1 px-4 py-3 bg-purple-600 text-white font-bold rounded-xl hover:bg-purple-700 transition-all flex items-center justify-center gap-2"
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                      </svg>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  <button
                    onClick={() => setShowAdaptModal(true)}
                    className="px-4 py-2 rounded-lg bg-gradient-to-r from-deep-indigo to-purple-600 text-white font-bold shadow-lg hover:shadow-xl hover:scale-105 transition-all flex items-center gap-2 text-sm"
                    title="Agency Feature - Adapt improved content for a different industry"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                    </svg>
      ...
      <AdaptToVerticalModal
        ...
        content={rewriteResult?.improvedContent || auditResult?.content || contentInput || ''}
        title={auditResult?.title || titleInput}
